...
const glassColorMap = {
  blue: {
    card: "from-blue-500/10 to-blue-400/5 border-blue-500/20 text-blue-400 group-hover:border-blue-500/50",
    button: "border-blue-400/50 text-blue-400 hover:shadow-[0_0_15px_rgba(59,130,246,0.6)]",
    icon: "bg-blue-500/10 text-blue-400",
  },
  purple: {
    card: "from-purple-500/10 to-purple-400/5 border-purple-500/20 text-purple-400 group-hover:border-purple-500/50",
...
export function Certificates() {
  return (
    <section id="certificates" className="py-24 md:py-32 relative overflow-hidden bg-black/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {certificates.map((cert) => (
              <Card
                key={cert.title}
                className={`
                  backdrop-blur-md bg-gradient-to-br border rounded-xl transition-all duration-500 group overflow-hidden 
                  hover:-translate-y-2 hover:shadow-2xl
                  ${glassColorMap[cert.color].card}
                `}
              >
                 <div className={`absolute inset-0 blur-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-500 rounded-xl bg-current`} />
