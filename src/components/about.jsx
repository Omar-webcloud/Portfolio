    ...
    <div className="relative w-full h-full flex flex-col items-center">
      <div className="container mx-auto px-4 sm:px-8 py-6 sm:py-12 lg:py-16 relative z-10 w-full h-full overflow-y-auto overflow-x-hidden scrollbar-hide transition-colors duration-500">
        ...
        <motion.div 
          ...
          className="w-full max-w-[1050px] mx-auto bg-card dark:border dark:border-border rounded-[32px] sm:rounded-[40px] md:rounded-[48px] relative z-10 flex flex-col md:flex-row shadow-2xl dark:shadow-[2px_2px_0px_oklch(0.13_0.01_260),0_8px_32px_rgba(0,0,0,0.45)] transition-colors duration-700"
        >
